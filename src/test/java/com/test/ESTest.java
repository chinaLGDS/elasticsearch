...
public class ESTest {
    ...
    public void createIndexStu(){
        ...
        stu.setAge(20);
        stu.setMoney(20.3f);
        stu.setSign("i am a  man");
        stu.setDescription("I have a good friend");
        //
    ...
    public void updateStuDoc(){
        ...
        sourceMap.put("money",9.8f);
        // sourceMap.put("age",35);
        sourceMap.put("sign","welcome ");

        IndexRequest indexRequest = new IndexRequest();
        indexRequest.source(sourceMap);

        //索引更新构造器，制定需要更新的文档数据(索引库的位置)，携带更新的id，放入索引文档数据的内容
...
//    ------------------------------------  我是分割线  ---------------------------------
    ...
    public void searchStuDoc(){
        ...
        SearchQuery query = new NativeSearchQueryBuilder()
                            .withQuery(QueryBuilders.matchQuery("description","i have a good friend"))
